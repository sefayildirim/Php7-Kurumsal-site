  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div align="right" class="col-md-12 col-sm-12 col-xs-12 col-md-offset-3">
        <button type="submit" name="etkinliklerkaydet" class="btn btn-primary">
      ...
      <br>
        ...
        <div class="form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="file" id="first-name" required="required" name="etkinlikler_etkinlikleryol"  class="form-control col-md-7 col-xs-12">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="text" id="first-name" required="required" name="etkinlikler_tarih" value="" class="form-control col-md-7 col-xs-12">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <input type="text" id="first-name" required="required" name="etkinlikler_baslik" value="" class="form-control col-md-7 col-xs-12">
          </div>
        </div>
           <div class="form-group">
            <label for="example-text-input" class="col-form-label">İçerik</label>

            <textarea  class="ckeditor" id="editor1" name="etkinlikler_icerik"></textarea>
          </div>
